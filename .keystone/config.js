...
var lists = {
  ...
  Event: (0, import_core.list)({
    ...
    fields: {
      ...
      venue: (0, import_fields.text)(),
      date: (0, import_fields.calendarDay)({
        defaultValue: "2023-01-01",
        db: { map: "my_date" },
        validation: { isRequired: true }
      }),
      ticket: (0, import_fields.relationship)({ ref: "Ticket.event", many: true })
    }
  }),
  Ticket: (0, import_core.list)({
    // WARNING
    //   for this starter project, anyone can create, query, update and delete anything
    //   if you want to prevent random people on the internet from accessing your data,
    //   you can find out more at https://keystonejs.com/docs/guides/auth-and-access-control
  ...
  User: (0, import_core.list)({
    ...
    fields: {
      ...
      telegramUsername: (0, import_fields.text)(),
      telegramId: (0, import_fields.text)({ isIndexed: "unique" }),
      submitedName: (0, import_fields.text)(),
      email: (0, import_fields.text)(),
      ticket: (0, import_fields.relationship)({ ref: "Ticket.owner", many: true })
    }
    // hooks:{
